...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($nome)) {
        ...
        $sql = "INSERT INTO contatos (nome, email, telefone, status, data_criacao) 
                VALUES ('$nome', '$email', '$telefone', 'ativo', NOW())";
        
        if ($conexao->query($sql) === TRUE) {
            header("Location: index.php?msg=Contato adicionado com sucesso!&tipo=success");
            exit;
        } else {
            $mensagem = "Erro ao adicionar contato: " . $conexao->error;
            $tipo_mensagem = "error";
        }
    }
}
